...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col">
                    <form action="{{ route('assign_subject.update',['class_id'=>$assign_subjects[0]->class_id]) }}" method='POST'>
                        @csrf
                        @method('PUT')
                            <div class="row">
                                <div class="col-12">
                                            ...
                                            <div class="controls">
                                                <select name="class_id" id="select"  class="form-control">
                                                    ...
                                                    <option value="{{ $class->id }}"
                                                        {{ old('class_id')==$class->id  ? 'selected' : ''  }} {{ $assign_subjects[0]->class_id==$class->id ? 'selected' : '' }}>
                                                        {{ $class->name }}</option>
                                                    @endforeach
                                                        ...
                                                        <div class="controls">
                                                            <select name="subject_id[]" required  class="form-control">
                                                                ...
                                                                <option value="{{ $subject->id }}"
                                                                    {{ old('subject_id')==$subject->id  ? 'selected' : ''  }} {{ $assign_subject->subject_id==$subject->id ? 'selected' : '' }}>
                                                                    {{ $subject->name }}</option>
                                                                @endforeach
