        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ $prefix=='/profile' ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('profile.pass.edit',['user'=>Auth::user()->id]) }}"><i class="ti-more"></i>Change Password</a></li>
            ...
            <li class="treeview {{ $prefix_str=='students'  ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('student.roll.index') }}"><i class="ti-more"></i>Roll Generator</a></li>
                </ul>
            </li>
